...
// These are real Unsplash source URLs — they resolve to random relevant photos
// In production, replace with your actual Cloudinary URLs after upload
...
// ─── Venue Template Data ────────────────────────────────────────────────────
// 50 hand-crafted Israeli venue profiles
const VENUE_TEMPLATES: Omit<VenueSeed, "lat" | "lng" | "address">[] = [
  ...
  // ── Herzliya & Greater Tel Aviv Area (26–32) ────────────────────────────
  {
  ...
  // ── Mix: Special/Unique Spaces (44–50) ───────────────────────────────────
  {
